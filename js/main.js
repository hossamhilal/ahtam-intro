$(function(){
    ...
    $("body").niceScroll({
        cursorcolor: "rgba(173, 118, 129,.97)",
        cursorwidth: "8px",
    ...
    $(window).scroll(function () {
        if($(this).scrollTop() >= 200){
            $('.navbar').css('background-color','rgb(170, 114, 125, .97)');
            $('.navbar .navbar-brand img').css('width','80%');
        }else{
    ...
    $('.navbar-toggler').click(function (){
        $('.navbar').css('background-color','rgba(78, 94, 105, 0.97)');
    });
